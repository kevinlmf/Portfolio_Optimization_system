...
try:
    from m2_market.regime_detector import MarketRegimeDetector
    # AssetConfigurationAnalyzer might not exist, create a dummy if needed
    try:
        from m2_market.regime_detector import AssetConfigurationAnalyzer
    except ImportError:
        AssetConfigurationAnalyzer = None
except ImportError:
    from strategy.market_regime_detector import MarketRegimeDetector
    try:
        from strategy.market_regime_detector import AssetConfigurationAnalyzer
    except ImportError:
        AssetConfigurationAnalyzer = None
